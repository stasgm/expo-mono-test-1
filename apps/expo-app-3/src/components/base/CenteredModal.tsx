...
const CenteredModal: FC<Props> = ({ visible, onRequestClose, children, title, avoidKeyboard }) => {
  ...
  return (
    <Modal visible={visible} onBackdropPress={onRequestClose} backdropStyle={styles.backdrop}>
