...
const Button = ({ label, icon, outline, ghost, appearance: passedAppearance, ...props }: Props) => {
  ...
  const accessory: Props['accessoryLeft'] = icon ? (p) => <Icon {...p} name={icon.name} size={icon.size} /> : undefined;
